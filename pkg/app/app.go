...
func (a *App) InitGlobalFlags() {
	...
	a.RootCmd.PersistentFlags().BoolVarP(&a.Config.GlobalFlags.TLSReload, "tls-reload", "", false, "reload TLS certificates from disk on reconnect when the cert file changes")
